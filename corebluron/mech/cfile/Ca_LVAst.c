...
#define _nrn_init _nrn_init__Ca_LVAst
#define _nrn_initial _nrn_initial__Ca_LVAst
#define _nrn_cur _nrn_cur__Ca_LVAst
#define _nrn_current _nrn_current__Ca_LVAst
#define _nrn_jacob _nrn_jacob__Ca_LVAst
#define _nrn_state _nrn_state__Ca_LVAst
...
#define _ion_ica	_nt->_data[_ppvar[1]]
#define _ion_dicadv	_nt->_data[_ppvar[2]]
