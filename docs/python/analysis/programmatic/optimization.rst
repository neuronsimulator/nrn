...
.. function:: h.fit_praxis(n, "funname", x._ref_x[0])
              h.fit_praxis(n, "funname", Vector)
              h.fit_praxis(..., ..., ..., "after quad statement")
              h.fit_praxis(efun_as_python_callable, neuron_vector)
...
.. function:: h.attr_praxis(tolerance, maxstepsize, printmode)
              h.attr_praxis(mcell_ran4_index)
...
.. function:: h.pval_praxis(i)
              h.pval_praxis(i, paxis._ref_x[0])
              h.pval_praxis(i, Vector)
