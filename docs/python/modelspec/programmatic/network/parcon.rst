...
.. method:: ParallelContext.mpiabort_on_error(newflag)
...
.. method:: ParallelContext.context(python_callable, arg1, ...)
            ParallelContext.context(userid, ..as above..)
...
.. method:: ParallelContext.post(key)
            ParallelContext.post(key, ...)
...
.. method:: ParallelContext.take(key)
            ParallelContext.take(key, ...)
...
.. method:: ParallelContext.look(key)
            ParallelContext.look(key, ...)
...
.. method:: ParallelContext.look_take(key, ...)
...
.. method:: ParallelContext.upkstr(str)
...
.. method:: ParallelContext.vtransfer_time()
            ParallelContext.vtransfer_time(1)
            ParallelContext.vtransfer_time(2)
...
.. method:: ParallelContext.allreduce(value, type)
            ParallelContext.allreduce(src_dest_vector, type)
...
.. method:: ParallelContext.allgather(value, result_vector)
...
.. method:: ParallelContext.alltoall(vsrc, vcnts, vdest)
...
.. method:: ParallelContext.py_alltoall(srclist)
...
.. method:: ParallelContext.py_allgather(srcitem)
...
.. method:: ParallelContext.py_gather(srcitem, root)
...
.. method:: ParallelContext.py_scatter(srclist, root)
...
.. method:: ParallelContext.py_broadcast(srcitem, root)
...
.. method:: ParallelContext.broadcast(strdef, root)
            ParallelContext.broadcast(vector, root)
...
.. method:: ParallelContext.subworlds(subworld_size)
...
.. method:: ParallelContext.set_gid2node(gid, id)
...
.. method:: ParallelContext.gid_exists(gid)
...
.. method:: ParallelContext.threshold(gid)
            ParallelContext.threshold(gid, th)
...
.. method:: ParallelContext.cell(gid, netcon)
            ParallelContext.cell(gid, netcon, 0)
...
.. method:: ParallelContext.outputcell(gid)
...
.. method:: ParallelContext.spike_record(gid, spiketimevector, gidvector)
...
.. method:: ParallelContext.gid_connect(srcgid, target)
            ParallelContext.gid_connect(srcgid, target, netcon)
...
.. method:: ParallelContext.psolve(tstop)
...
.. method:: ParallelContext.timeout(seconds)
...
.. method:: ParallelContext.set_maxstep(default_max_step)
...
.. method:: ParallelContext.spike_compress({nspike}, {gid_compress})
...
.. method:: ParallelContext.gid2obj(gid)
...
.. method:: ParallelContext.gid2cell(gid)
...
.. method:: ParallelContext.spike_statistics(_ref_nsend, _ref_nrecv, _ref_nrecv_useful)
...
.. method:: ParallelContext.max_histogram(vec)
...
.. method:: ParallelContext.source_var(_ref_v, source_global_index, sec=section)
...
.. method:: ParallelContext.target_var(_ref_target_variable, source_global_index)
            ParallelContext.target_var(targetPointProcess, _ref_target_variable, source_global_index)
...
.. method:: ParallelContext.splitcell(host_with_other_subtree, sec=rootsection)
...
.. method:: ParallelContext.multisplit(section(x), sid)
            ParallelContext.multisplit(section(x), sid, backbone_style)
...
.. method:: ParallelContext.gid_clear()
            ParallelContext.gid_clear(type)
...
.. method:: ParallelContext.nthread(n)
            ParallelContext.nthread(n, 0)
...
.. method:: ParallelContext.partition(i, seclist)
...
.. method:: ParallelContext.thread_busywait(next)
...
.. method:: ParallelContext.sec_in_thread(sec=section)
...
.. method:: ParallelContext.thread_ctime(i)
...
.. method:: ParallelContext.t(tid)

    Return the current time of the tid'th thread

----

.. method:: ParallelContext.dt(tid)
...
.. method:: ParallelContext.prcellstate(gid, "suffix")
...
..  method:: ParallelContext.nrncore_write([path[, append_files_dat]])
...
..  method:: ParallelContext.nrncore_run(argstr, [bool])
