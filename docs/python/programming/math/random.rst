...
.. method:: Random.MCellRan4()
            Random.MCellRan4(highindex)
            Random.MCellRan4(highindex, lowindex)
...
.. method:: Random.Random123(id1, id2, id3)
...
.. method:: Random.Random123_globalindex([uint32])
...
()
    Syntax:
        ``currenthighindex = r.seq(sethighindex)``
...
.. method:: Random.uniform(low, high)
...
.. method:: Random.discunif(low, high)
...
.. method:: Random.normal(mean, variance)
...
.. method:: Random.lognormal(mean, variance)
...
.. method:: Random.hypergeo(mean,variance)
...
.. method:: Random.erlang(mean,variance)
...
.. method:: Random.weibull(alpha,beta)
