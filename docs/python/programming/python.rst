...
.. method:: neuron.hoc.hoc_ac(double_value)
...
.. class:: neuron.h.Section()
           neuron.h.Section([name='string', [cell=self])
...
.. function:: nrnpython("any python statement")
...
.. method:: neuron.hoc.execute('any hoc statement'
