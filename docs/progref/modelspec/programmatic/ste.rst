...
.. method:: StateTransitionEvent.transition
    ...
    .. tab:: Python
      ...
      Syntax:
        ``ste.transition(isrcstate, ideststate, _ref_triggervar, _ref_triggerthresh)``
        
        ``ste.transition(isrcstate, ideststate, _ref_triggervar, _ref_triggerthresh, "hoc statement")``
      ...
      Description:
        ...
        ``hoc statement`` or ``pycallable`` are optional arguments. They are executed when the transition takes place. Note that number of
    ...
    .. tab:: HOC
        ...
        Syntax:
          ...
          ``ste.transition(isrcstate, ideststate, &triggervar, &triggerthresh)``
