...
.. class:: rxd.Species
    ...
    .. tab:: Python
        ...
        .. property:: rxd.Species.nodes
            ...
            This can then be further restricted using the callable property of :class:`NodeList` objects.
...
.. class:: rxd.Reaction
    ...
    .. tab:: HOC
        ...
        notation, consider defining the rate expression in Python via :func:`nrnpython`.
...
.. class:: rxd.Rate
    ...
    .. tab:: HOC
        ...
        If there are multiple :class:`rxd.Rate` objects (or an 
        :class:`rxd.Reaction`, etc) acting on
        the same species, then their effects are summed.
...
.. method:: rxd.node.Node1D.satisfies
    ...
    .. tab:: HOC
        ...
        If a number between 0 and 1 is provided, returns ``1`` if the normalized position lies within the Node; else ``0``.
