...
.. class:: ParallelContext
    ...
    .. tab:: HOC
        ...
        Description:
            ...
            :class:`ParallelNetManager` and :ref:`hoc_ParallelTransfer` discussions.
...
.. note::
    ...
    The following instructions for installing MPI are dated and are
    retained for historical interest.

    In theory any implementation of MPI should do, and you can find
    plenty of guides online for how to install it on your laptop or
    desktop. (On an HPC, MPI is almost certainly already available.)
...
.. method:: ParallelContext.psolve
    ...
    .. tab:: Python
        ...
        Note:
            ...
            interleaved and calls to :func:`finitialize` can be interspersed. The result
        ...
        Description:
            ...
            .. list-table::
               ...
               * - Bit
                 - Usage
               * - 0
                 - 0: Allgather, 1: Multisend (MPI_ISend)
               * - 1
                 - unused
               * - 2
                 - 0: multisend_interval = 1, 1: multisend_interval = 2
               * - 3
                 - 0: don't use phase2, 1: use phase2
...
..  method:: ParallelContext.nrncore_write
    ...
    .. tab:: Python
        ...
        Description:
            ...
            Rank 0 writes a file called :file:`bbcore_mech.dat` (into path) which lists
            ...
            At the end of the :file:`bbcore_mech.dat`` file is a binary value that is
            ...
            appended to the :file:`files.dat`` file. Note that one can either create
