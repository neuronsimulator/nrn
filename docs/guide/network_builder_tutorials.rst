...
Before starting this one, make sure you know how to use the CellBuilder (if you haven't already done so, you might want to get the `CellBuilder tutorial <https://www.neuronsimulator.org/en/latest/courses/cellbuilder_overview_and_hints.html?>`_ and work through it).
