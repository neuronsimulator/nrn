...
.. tab-set::
   ...
   .. tab-item:: macOS
      ...
      Alternatively, you can use the `PKG installer <https://github.com/neuronsimulator/nrn/releases/download/8.2.7/nrn-8.2.7-macosx-10.15-universal2-py-39-310-311-312-313.pkg>`_.
