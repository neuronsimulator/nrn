...
.. tab-set::
   ...
   .. tab-item:: macOS
      ...
      Alternatively, you can use the `PKG installer <hhttps://github.com/neuronsimulator/nrn/releases/download/8.2.0/nrn-8.2.0-macosx-10.9-universal2-py-38-39-310.pkg>`_.
