...
int nrn_newton_thread(NewtonSpace* ns, int n, int* index, double** x, newton_fptr_t pfunc, double* value, Datum* ppvar, Datum* thread, NrnThread* nt, Memb_list* ml, size_t iml);
