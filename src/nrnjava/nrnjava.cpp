...
static double joequals(void* v) {
    ...
    if (o2->ctemplate->constructor == joconstruct     // a JavaObject
        ...
        return (nrnjava_env->CallStaticIntMethod(neuronCls, identityID, jo1, jo2) != 0) ? 1. : 0.;
    }
    return 0.;
}
...
static const char** joname(void* v) {
    jstring js =
        (jstring) nrnjava_env->CallStaticObjectMethod(neuronCls, jclassnameID, (jobject) v);
    return (const char**) js2charpool(js);
}

static Member_func jo_members[] = {"equals", joequals, 0, 0};
static Member_ret_str_func jo_retstr_members[] = {"name", joname, 0, 0};
...
void nrnjava_init() {
    ...
    if (neuronCls == 0) {
        ...
        printf(
            "Look in the Redirect.out file of the current working directory for the reason for "
            "failure\n");
        return;
    }
    ...
    nrnclsldID =
        nrnjava_env->GetStaticMethodID(nrnclsldr, "load", "(Ljava/lang/String;)Ljava/lang/Class;");
    ...
    constructNoArgID =
        nrnjava_env->GetStaticMethodID(neuronCls, "constructNoArg", "(I)Ljava/lang/Object;");
    constructWithArgID =
        nrnjava_env->GetStaticMethodID(neuronCls, "constructWithArg", "(I)Ljava/lang/Object;");
    makeHocClassID = nrnjava_env->GetStaticMethodID(
        neuronCls, "makeHocClass", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I");
    invokeDoubleMethodID =
        nrnjava_env->GetStaticMethodID(neuronCls, "invokeDoubleMethod", "(Ljava/lang/Object;III)D");
    invokeCharsMethodID = nrnjava_env->GetStaticMethodID(
        neuronCls, "invokeCharsMethod", "(Ljava/lang/Object;III)Ljava/lang/String;");
    invokeObjectMethodID = nrnjava_env->GetStaticMethodID(
        neuronCls, "invokeObjectMethod", "(Ljava/lang/Object;III)Ljava/lang/Object;");
    encapsulateID =
        nrnjava_env->GetStaticMethodID(neuronCls, "encapsulateHocObject", "(JI)Ljava/lang/Object;");
    getObjectTypeID =
        nrnjava_env->GetStaticMethodID(neuronCls, "getObjectType", "(Ljava/lang/Object;)I");
    setwinID = nrnjava_env->GetStaticMethodID(neuronCls, "setwin", "(JIII)I");
    ...
    hocObjectCastID = nrnjava_env->GetFieldID(hoCls, "hocObjectCast", "J");
...
static bool java2nrn_identity(Object* o1, Object* o2) {
    ...
    if (o1 == 0 || o2 == 0)
        return false;
    return (nrnjava_env->CallStaticIntMethod(neuronCls,
                                             identityID,
                                             (jobject) o1->u.this_pointer,
                                             (jobject) o2->u.this_pointer) != 0)
               ? true
               : false;
}
...
static void* java2nrn_cons(Object* o) {
    ...
    jobject newo;
    if (!ifarg(1)) {
        newo = nrnjava_env->CallStaticObjectMethod(neuronCls, constructNoArgID, cid);
    } else {
        newo = nrnjava_env->CallStaticObjectMethod(neuronCls, constructWithArgID, cid);
    }
    jobject ret = 0;
...
static void overloaded(Object* ho, Symbol* method) {
    ...
    for (Symbol* s = ho->ctemplate->symtable->first; s; s = s->next) {
        if (s != method && strncmp(s->name, method->name, n) == 0 && isdigit(s->name[n])) {
            printf("	%s\n", s->name);
        }
    }
...
static double java2nrn_dmeth(Object* ho, Symbol* method) {
    ...
    double d = (double) nrnjava_env->CallStaticDoubleMethod(neuronCls,
                                                            invokeDoubleMethodID,
...
static char** java2nrn_smeth(Object* ho, Symbol* method) {
    ...
    jstring js = (jstring) nrnjava_env->CallStaticObjectMethod(neuronCls,
                                                               invokeCharsMethodID,
                                                               (jobject) ho->u.this_pointer,
                                                               -(jint) ho->ctemplate->id - 1,
                                                               (jint) method->u.u_auto,
...
static Object** java2nrn_ometh(Object* ho, Symbol* method) {
    ...
    jobject jo = nrnjava_env->CallStaticObjectMethod(neuronCls,
                                                     invokeObjectMethodID,
                                                     (jobject) ho->u.this_pointer,
                                                     -(jint) ho->ctemplate->id - 1,
                                                     (jint) method->u.u_auto,
                                                     (jint) method->s_varn);
    ...
    jint type = 0;
    if (jo) {
        type = nrnjava_env->CallStaticIntMethod(neuronCls, getObjectTypeID, jo);
    }
...
jobject nj_encapsulate(Object* ho) {
    ...
    jo = nrnjava_env->CallStaticObjectMethod(neuronCls, encapsulateID, (jlong) ho, type);
...
static void pwm_setwin(void* win, int type, int left, int top) {
    ...
    if (nrnjava_root_env == nrnjava_env) {
        nrnjava_env->CallStaticIntMethod(neuronCls, setwinID, (jlong) win, type, left, top);
    } else {
        printf("nrnjava_env = %ld  nrnjava_root_env = %ld\n",
               (long) nrnjava_env,
               (long) nrnjava_root_env);
    }
}
