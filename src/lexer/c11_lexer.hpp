#ifndef C11_LEXER_HPP
#define C11_LEXER_HPP
...
#ifndef YY_DECL
#define YY_DECL c11::Parser::symbol_type c11::Lexer::next_token()
#endif
...
#define yyFlexLexer C11FlexLexer
#include "FlexLexer.h"
#endif
...
namespace c11 {
     ...
     * of macros. */
    class Lexer : public C11FlexLexer {
      public:
        ...
        explicit Lexer(Driver& drv, std::istream* in = nullptr, std::ostream* out = nullptr)
            : C11FlexLexer(in, out), driver(drv) {}
