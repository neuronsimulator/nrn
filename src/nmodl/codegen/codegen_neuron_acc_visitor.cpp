...
void CodegenNeuronAccVisitor::print_parallel_iteration_hint(BlockType type,
    ...
    // Exclusive residual (post H4+B): jacob is g_unused → vec_d only. No GLOBAL,
    // voltages, _thread, or fat Instance — present(hh_global) was residual H→D
    // tax on TABLE mechs (~95 ms/run ACC_TIME under nrn_jacob_hh).
