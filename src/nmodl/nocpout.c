...
");
    if (brkpnt_exists) {
        Lappendstr(defs_list,
                   ...
                   "nrn_jacob(_NrnThread*, _Memb_list*, int);\n");
    }
...
static int decode_limits(sym, pg1, pg2) Symbol* sym;
double *pg1, *pg2;
{
    int i;
    double d1;
...
static int decode_tolerance(sym, pg1) Symbol* sym;
double* pg1;
{
    int i;
    double d1;
...
static void var_count(s) Symbol* s;
{
    defs_h(s);
    s->used = varcount++;
...
void nrn_list(q1, q2) Item *q1, *q2;
{
    List** plist = (List**) 0;
    Item* q;
...
void bablk(ba, type, q1, q2) int ba, type;
Item *q1, *q2;
{
    Item *qb, *qv, *q;
    ...
    sprintf(
        buf,
        "static void _ba%d(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, _NrnThread* _nt) ",
        ++ba_index_);
    insertstr(q1, buf);
    q = q1->next;
...
void nrn_use(q1, q2, q3, q4) Item *q1, *q2, *q3, *q4;
{
    int used, i;
    Item *q, *qr, *qw;
...
static Symbol* ifnew_install(name) char* name;
{
    Symbol* s;
...
static void del_range(range) List* range;
{
    Item *q, *q1;
    Symbol* s;
...
List* set_ion_variables(block) int block; /* 0 means equation block , 2 means initial block */
{
    /*ARGSUSED*/
    Item *q, *q1, *qconc;
    char* in;
...
List* get_ion_variables(block) int block; /* 0 means equation block */
...
List* end_dion_stmt(strdel) char* strdel;
{
    Item *q, *q1;
    static List* l;
    char* strion;
...
static void ion_promote(qion) Item* qion;
{
    Item* q;
    char* in;
    int conc, rev;
...
void slist_data(s, indx, findx) Symbol* s;
int indx, findx;
{
...
void cvode_interface(fun, num, neq) Symbol* fun;
int num, neq;
{
...
void net_receive(qarg, qp1, qp2, qstmt, qend) Item *qarg, *qp1, *qp2, *qstmt, *qend;
{
    Item *q, *q1;
    Symbol* s;
    int i, b;
...
void net_init(qinit, qp2) Item *qinit, *qp2;
{
...
void fornetcon(keyword, par1, args, par2, stmt, qend) Item *keyword, *par1, *args, *par2, *stmt,
    *qend;
{
    Item *q, *q1;
    Symbol* s;
