...
static void unit_chk(name, unit) char *name, *unit;
{
    Symbol* s;
...
void nrn_list(qtype, qlist) Item *qtype, *qlist;
{
    List** plist;
    Item* q;
...
void nrn_use(qion, qreadlist, qwritelist) Item *qion, *qreadlist, *qwritelist;
{
    int i;
    List* l;
    Item* q;
