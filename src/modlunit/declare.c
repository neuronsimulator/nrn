...
void declare(subtype, q, qa) long subtype;
Item *q, *qa;
{
    Symbol* sym;
...
static int promote(sym, sub) Symbol* sym;
long sub;
{
    /*ARGSUSED*/
...
void declare_indep(sym) Symbol* sym;
{
    Item** qa;
...
void define_value(q1, q2) Item *q1, *q2;
{
    Symbol* s;
    s = SYM(q1);
    if (s->subtype) {
...
Symbol* basestate(s) /* base state symbol for state''' or state0 */
    Symbol* s;
{
    Symbol* base = SYM0;
