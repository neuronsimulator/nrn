...
static void openfiles(argc, argv) int argc;
char* argv[];
{
...
void printitems(q1, q2) Item *q1, *q2;
{
    Item* q;
...
void debugitem(q) Item* q;
{ debug_item(q, 0, stderr); }

static void debug_item(q, indent, file) Item* q;
int indent;
FILE* file;
{
    int i;
