...
declareArrayPool(CharArrayPool, char) implementArrayPool(CharArrayPool, char)

#define APSIZE 1000
    declareArrayPool(DoubleArrayPool, double) implementArrayPool(DoubleArrayPool, double)
        declareArrayPool(DatumArrayPool, Datum) implementArrayPool(DatumArrayPool, Datum)
...
declareStructPool(SectionPool, Section)
    implementStructPool(SectionPool, Section) static SectionPool* secpool_;
