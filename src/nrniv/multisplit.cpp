...
declareNrnHash(Int2IntTable, int, int) implementNrnHash(Int2IntTable, int, int)
...
declareNrnHash(MultiSplitTable, Node*, MultiSplit*)
    implementNrnHash(MultiSplitTable, Node*, MultiSplit*) declarePtrList(MultiSplitList, MultiSplit)
