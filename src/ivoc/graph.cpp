...
static const Member_func gr_members {
    {"plot", gr_plot}, {"fastflush", gr_fast_flush}, {"flush", gr_flush}, {"xaxis", gr_xaxis},
        {"yaxis", gr_yaxis}, {"addvar", gr_addvar}, {"addexpr", gr_addexpr},
        {"addobject", gr_addobject}, {"glyph", gr_addglyph}, {"vector", gr_vector},
        {"xexpr", gr_xexpr}, {"begin", gr_begin}, {"erase", ivoc_gr_erase}, {"size", ivoc_gr_size},
        {"label", ivoc_gr_label}, {"fixed", gr_fixed}, {"vfixed", gr_vfixed},
        {"relative", gr_relative}, {"align", gr_align}, {"color", gr_color}, {"brush", gr_brush},
        {"view", gr_view}, {"save_name", gr_save_name}, {"beginline", ivoc_gr_begin_line},
        {"line", ivoc_gr_line}, {"mark", ivoc_gr_mark}, {"simgraph", gr_simgraph},
        {"view_count", gr_view_count}, {"erase_all", ivoc_erase_all}, {"unmap", gr_unmap},
        {"crosshair_action", gr_set_cross_action}, {"printfile", gr_printfile},
        {"family", gr_family}, {"menu_action", ivoc_gr_menu_action},
        {"menu_tool", ivoc_gr_menu_tool}, {"view_info", ivoc_view_info},
        {"view_size", ivoc_view_size},
#if HAVE_IV
        {"getline", gr_getline},
#endif
        {"exec_menu", exec_menu}, {"gif", ivoc_gr_gif}, {"menu_remove", ivoc_gr_menu_remove}, {
