...
bool ok_to_write(const String&, Window* w=nil);
bool ok_to_write(const char*, Window* w=nil);
bool ok_to_read(const String&, Window* w=nil);
bool ok_to_read(const char*, Window* w=nil);
...
bool str_chooser(const char*, char*, Window* w=nil, Coord x = 400., Coord y = 400.);
bool var_pair_chooser(const char*, float& x, float& y, Window* w=nil,
