...
#define FWrite(arg1, arg2, arg3, arg4)                      \
    if (fwrite((char*) (arg1), arg2, arg3, arg4) != arg3) { \
        hoc_execerror("fwrite error", 0);                   \
    }
#define FRead(arg1, arg2, arg3, arg4)                      \
    if (fread((char*) (arg1), arg2, arg3, arg4) != arg3) { \
...
static double v_fit(void* v) {
    ...
    */
    ...
    if (fitted->capacity() != y->capacity())
        fitted->resize(y->capacity());
...
static Object** v_psth(void* v) {
    ...
    double size = chkarg(4, 0, v1->capacity() / 2);
    int n = int(v1->capacity());
