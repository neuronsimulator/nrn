...
void register_rate(int nspecies, int nparam, int nregions, int nseg, int* sidx,
                   int necs, int necsparam, int* ecs_ids, int* ecsidx,
                   int nmult, double* mult, PyHocObject** vptrs,
                    ReactionRate f)
{
