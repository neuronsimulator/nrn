...
extern "C" NB_EXPORT PyObject* nrn_hocobj_ptr(double* pd) {
...
extern "C" NB_EXPORT int nrnpy_set_gui_callback(PyObject* new_gui_callback) {
...
extern "C" NB_EXPORT int nrnpy_rvp_pyobj_callback_register(PyObject* callback) {
