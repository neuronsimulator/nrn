...
extern "C" NRN_EXPORT void rxd_setup_conc_ptrs(int conc_count, int* conc_index, PyHocObject** conc_ptrs) {
...
extern "C" NRN_EXPORT void rxd_include_node_flux1D(int n, long* index, double* scales, PyObject** sources) {
...
extern "C" NRN_EXPORT void setup_solver(double* my_states, int my_num_states, long* zvi, int num_zvi) {
    free_currents();
    states = my_states;
