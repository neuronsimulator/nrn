...
void hoc_negate();
extern void hoc_add(void), hoc_sub(void), hoc_mul(void), hoc_div(void), hoc_cyclic(void), hoc_power(void);
void hoc_assign();
extern void hoc_bltin(void), hoc_varpush(void), hoc_constpush(void), hoc_print(void), hoc_varread(void);
...
void hoc_eq();
void hoc_lt();
extern void hoc_gt(void), hoc_ge(void), hoc_le(void), hoc_ne(void), hoc_and(void), hoc_or(void), hoc_not(void);
void hoc_arg();
extern void hoc_ifcode(void), hoc_forcode(void), hoc_shortfor(void), hoc_call(void), hoc_argassign(void);
extern void hoc_argrefasgn(void), hoc_argref(void), hoc_iterator(void), hoc_iterator_stmt(void);
extern void hoc_funcret(void), hoc_procret(void), hoc_Break(void), hoc_Continue(void), hoc_Stop(void);
