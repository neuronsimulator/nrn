...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 static double _t_minf[201] = {0};
 static double _t_mtau[201] = {0};
 static double _t_hinf[201] = {0};
 static double _t_htau[201] = {0};
 static double _t_ninf[201] = {0};
 static double _t_ntau[201] = {0};
