...
#define _threadargsproto_ int _iml, int _cntml_padded, double* _p, Datum* _ppvar, ThreadDatum* _thread, NrnThread* _nt, double _v
...
#pragma acc routine seq
extern int sparse_thread(SparseObj*, int, int*, int*, double*, double, SPFUN, int,
                         _threadargsproto_);
#pragma acc routine seq
int _ss_sparse_thread(SparseObj*, int n, int* s, int* d, double* t, double dt,
