...
public:
	TvecRecord(Section*, IvocVect* tvec);
	virtual ~TvecRecord();
...
public:
	...
	VecPlayStep( const char* s, IvocVect* y, IvocVect* t, double dt);
...
public:
	...
	VecPlayContinuous( const char* s, IvocVect* y, IvocVect* t, IvocVect* discon);
