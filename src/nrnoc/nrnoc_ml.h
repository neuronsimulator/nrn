...
#if defined(__GNUC__)
#define NRN_PURE __attribute__((pure))
#else
#define NRN_PURE
#endif
...
struct Memb_list {
     ...
     */
    [[nodiscard]] NRN_PURE double* dptr_field(std::size_t instance, int variable);
     ...
     * code.
     */
    [[nodiscard]] NRN_PURE double const& data(std::size_t instance,
                                              int variable,
