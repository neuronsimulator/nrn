...
class Binomial_random123 : public Random_random123 {
    ...
    public:
        inline Binomial_random123(int t, double p, RNG_random123 *gen) : Random_random123(gen), d(std::binomial_distribution<>(t, p)) {
        }
...
class DiscreteUniform_random123: public Random_random123 {
    ...
    public:
        inline DiscreteUniform_random123(double low, double high, RNG_random123 *gen) : Random_random123(gen), d(std::uniform_int_distribution<>(low, high))
    {
    }
...
class Erlang_random123: public Random_random123 {
    ...
    public:
        ...
        inline Erlang_random123(double mean, double variance, RNG_random123 *gen) : Random_random123(gen), pMean(mean), pVariance(variance)
    {
        setState();
...
class Geometric_random123: public Random_random123 {
    ...
    public:
        Geometric_random123(double mean, RNG_random123 *gen)
            : Random_random123(gen), d(std::geometric_distribution<>(mean)) {}
...
class Uniform_random123: public Random_random123 {
    ...
    public:
        inline Uniform_random123(double low, double high, RNG_random123 *gen) : Random_random123(gen)
    {
...
class Weibull_random123: public Random_random123 {
    ...
    public:
        inline Weibull_random123(double alpha, double beta, RNG_random123 *gen) : Random_random123(gen)
    {
