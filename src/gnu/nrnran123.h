...
extern nrnran123_State* nrnran123_newstream(std::uint32_t id1,
                                            std::uint32_t id2 = 0,
                                            std::uint32_t id3 = 0);
/** @brief. Deprecated, use nrnran123_newstream **/
extern nrnran123_State* nrnran123_newstream3(std::uint32_t id1,
                                             std::uint32_t id2,
                                             std::uint32_t id3);
/** @brief with no args, each instance is an independent stream
...
extern void nrnran123_setseq(nrnran123_State*, double seq4which);  // seq*4+which);
extern void nrnran123_getids(nrnran123_State*, std::uint32_t* id1, std::uint32_t* id2);
extern void nrnran123_getids(nrnran123_State*,
                              std::uint32_t* id1,
                              std::uint32_t* id2,
                              std::uint32_t* id3);
