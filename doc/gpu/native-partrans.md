...
| **P4 scatter** | Bulk target scatter (de-chatty) | **green (on tip)** — pack host vals + bulk H→D + device write into field base+offset; ringtest gap 0 scalar H→D/step; was O(n) `memcpy_to_device` |
