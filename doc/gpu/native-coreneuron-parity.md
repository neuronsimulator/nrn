...
Both named children closed without recode. Remaining ~0.13 s vs CN GPU is
spread across several <0.05 s buckets. Do not reopen nonvint / setup /
device-ensure / deliver-tq / density without a new wall hypothesis.

### Starting prompt — Dentate nt1 setup-rhs (closed 2026-09-11; archive)

Session closed 2026-09-11: nested zero/cur/axial/wait. CURRENT loop 0.177 s;
zero 0.002; axial 0.002; wait 0.008. No recode. Product 0.739–0.741 ✅ 400.
