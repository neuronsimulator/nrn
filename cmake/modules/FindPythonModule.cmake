...
macro(nrn_find_python_module)
  ...
  if(_find_module_not_found OR _find_module_insufficient_version)
    ...
    if(_find_module_not_found)
      string(JOIN " " _find_module_not_found_string ${_find_module_not_found})
      string(APPEND _find_module_msg " not found with: ${_find_module_not_found_string}")
      if(_find_module_insufficient_version)
        string(APPEND _find_module_msg ",")
      endif()
    endif()
    if(_find_module_insufficient_version)
      string(JOIN " " _find_module_ivstr ${_find_module_insufficient_version})
      string(APPEND _find_module_msg
             " insufficient version with: ${_find_module_ivstr} (${_find_module_VERSION} needed)")
    endif()
