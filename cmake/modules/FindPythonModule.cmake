# Usage: nrn_find_python_module(MODULE module [VERSION version] [REQUIRED])
#
...
macro(nrn_find_python_module)
  cmake_parse_arguments(_find_module "REQUIRED" "MODULE;VERSION" "" ${ARGN})
  ...
  execute_process(
    COMMAND "${Python_EXECUTABLE}" "-c" "${_find_module_python_code}"
  ...
  if(_find_module_status)
    ...
    list(APPEND _find_module_not_found "${Python_EXECUTABLE}")
