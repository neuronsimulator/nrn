...
common_package(mod2c 1.1  REQUIRED )
...
if(mod2c_name)
  list(APPEND FIND_PACKAGES_DEFINES CORENEURON_USE_MOD2C)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND CORENEURON_DEPENDENT_LIBRARIES mod2c)
  endif()
  ...
  if(NOT "${${mod2c_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${mod2c_name}_INCLUDE_DIR})
  endif()
endif()
...
set(CORENEURON_DEPENDS MPI;mod2c;Boost)
