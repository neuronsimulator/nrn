...
# autoheader. We use repository copy cmake_nrnconf.h.in to create these files.
nrn_copy_file_if_different("${PROJECT_SOURCE_DIR}/cmake_nrnconf.h.in"
                           "${PROJECT_SOURCE_DIR}/nrnconf.h.in")
nrn_copy_file_if_different("${PROJECT_SOURCE_DIR}/cmake_nrnconf.h.in"
                           "${PROJECT_SOURCE_DIR}/nmodlconf.h.in")
...
if(MINGW)
  set(WIN_MARSHAL_DIR "c:\\marshalnrn")
