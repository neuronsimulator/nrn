...
macro(configure_ac_file file dir)
 ...
 if (0)
  ...
  # copy the autoconf .h files generated by .h.in into the proper places.
  ...
  # for i in `find . -name \*.h` ; do cp $i ../aconf; done
  # rm -r -f *
  execute_process(COMMAND cp ${PROJECT_SOURCE_DIR}/aconf/${file} ${bdir}/cmk_${file})
 endif()
