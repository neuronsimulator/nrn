...
if(NRN_ENABLE_COVERAGE)
  ...
  set(cover_baseline_command
      "${LCOV_LAUNCHER}" "--capture" "--initial" "--no-external" "--directory"
      "${PROJECT_SOURCE_DIR}" "--directory" "${PROJECT_BINARY_DIR}" "--output-file"
      "coverage-base.info")
  set(cover_collect_command
      "${LCOV_LAUNCHER}" "--capture" "--no-external" "--directory" "${PROJECT_SOURCE_DIR}"
      "--directory" "${PROJECT_BINARY_DIR}" "--output-file" "coverage-run.info")
  set(cover_combine_command
      "${LCOV_LAUNCHER}" "--add-tracefile" "coverage-base.info" "--add-tracefile"
