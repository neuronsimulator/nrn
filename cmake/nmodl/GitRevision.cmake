# For now use simple approach to get version information as
# git is always avaialble on the machine where we are building
...
if(GIT_FOUND)
    ...
    execute_process(COMMAND
        ${GIT_EXECUTABLE} log -1 --format=%ad --date=format:"%d-%m-%Y %H:%M"
        WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
