...
# ~~~
# =============================================================================
# Windows injects stdin after .hoc files (cygonce). -c quit() is a filearg so
# the process exits before that, like Unix after argv ends.
if(WIN32)
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E env HOC_LIBRARY_PATH=${hoc_library_path}
          ${executable} ${exec_arg} ${_nrn_hoc_extra}
