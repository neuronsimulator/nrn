# Often older version of flex is available in /usr.
# Even we set PATH for newer flex, CMake will set
# FLEX_INCLUDE_DIRS to /usr/include. This will result
# in compilation errors. Hence we check for flex include
# directory for the corresponding FLEX_EXECUTABLE.
# If found, we add that first and then we include
# include path from CMake.
