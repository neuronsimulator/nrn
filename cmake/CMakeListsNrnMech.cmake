...
set(_nrn_mech_compile_flags ${NRN_COMPILE_FLAGS} ${NRN_EXTRA_MECH_CXX_FLAGS})
if(NRN_ENABLE_GPU AND CORENRN_ENABLE_GPU)
  separate_arguments(_nrn_mech_acc_flags UNIX_COMMAND "${CORENRN_ACC_COMP_FLAGS}")
  list(APPEND _nrn_mech_compile_flags ${_nrn_mech_acc_flags})
  list(APPEND NRN_COMPILE_DEF_FLAGS -DNRN_ENABLE_GPU -DCORENEURON_ENABLE_GPU)
  string(JOIN " " NRN_COMPILE_DEFS_STRING ${NRN_COMPILE_DEF_FLAGS})
endif()
string(JOIN " " NRN_COMPILE_FLAGS_STRING ${_nrn_mech_compile_flags})
