...
class Node3D(Node):
    __slots__ = ('_index', '_i', '_j', '_k', '_neighbors', '_r', '_sec', '_x', 
                 '_speciesref', '_data_type', '_pos_x_neighbor', '_neg_x_neighbor',
                 '_pos_y_neighbor', '_neg_y_neighbor', '_pos_z_neighbor', '_neg_z_neighbor')
