...
#pyplot.savefig('./gif/tsttap_voltage_over_time'+str(sec.nseg)+"_"+str(nsubseg)+'.png')
pyplot.figure()
mydraw()
numpy.save("tapca_2d"+str(rxd.options.subseg_interpolation)+str(rxd.options.subseg_averaging)+"_nrxd"+str(sec.nseg)+"_"+str(nsubseg), data)
#pyplot.savefig('./gif/tsttap_ca_2d'+str(sec.nseg)+"_"+str(nsubseg)+'.png')
