...
:: nsis + plugin
:: pwsh -command Invoke-WebRequest -MaximumRetryCount 4 -OutFile nsis-3-05.exe https://fossies.org/windows/misc/nsis-3.05-setup.exe || goto :error
pwsh -command Invoke-WebRequest -MaximumRetryCount 4 -OutFile nsis-3-05.exe https://github.com/alexsavulescu/installers/raw/master/nsis-3.05-setup.exe || goto :error
