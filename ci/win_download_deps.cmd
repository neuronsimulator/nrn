...
pwsh -command Invoke-WebRequest -MaximumRetryCount 4 -OutFile python-3.14.exe https://www.python.org/ftp/python/3.14.0/python-3.14.0-amd64.exe || goto :error
...
:: nsis + plugin
pwsh -command Invoke-WebRequest -MaximumRetryCount 4 -OutFile nsis-3.05-setup.exe https://prdownloads.sourceforge.net/nsis/nsis-3.05-setup.exe || goto :error
