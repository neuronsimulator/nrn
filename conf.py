...
copyright = u'2015, Tom McTavish, Robert A McDougal, Michael L Hines'
...
intersphinx_mapping = {'py': ('http://docs.python.org/', None), 'neuron': ('http://www.neuron.yale.edu/neuron/static/new_doc/', None)}
