...
for test_config in python3.8:wheelhouse/NEURON-7.8.11.3-cp38-cp38-manylinux1_x86_64.whl \
                   python3.7:wheelhouse/NEURON-7.8.11.3-cp37-cp37m-manylinux1_x86_64.whl \
                   python3.6:wheelhouse/NEURON-7.8.11.3-cp36-cp36m-manylinux1_x86_64.whl \
                   python3.5:wheelhouse/NEURON-7.8.11.3-cp35-cp35m-manylinux1_x86_64.whl;
do
