...
# Environment for nrnivmodl + tests: venv tools first, no ambient PYTHONPATH.
set(NRN_RUN_FROM_BUILD_DIR_ENV "PATH=${_nrn_foreign_py_bindir}:$ENV{PATH}" "PYTHONPATH=")
...
function(nrn_foreign_note_nrnivmodl_group group_name)
  ...
  set(tname "${${prefix}_NRNIVMODL_TARGET_NAME}")
  if(tname AND TARGET "${tname}")
    set(_all "${NRN_FOREIGN_NRNIVMODL_TARGETS}")
    list(APPEND _all "${tname}")
